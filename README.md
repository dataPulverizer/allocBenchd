...
At the moment the chart is plotted using R's base graphic, here is an example of what the chart looks like: <img src="https://github.com/dataPulverizer/allocBenchd/blob/master/allocBench.jpeg" width="500">
